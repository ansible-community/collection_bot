...
**<a name="cmd-remove-label">-label</a>** | issues pull requests | staff maintainers | Remove a supported label. See [When to use label commands](#when-to-use-label-commands).
